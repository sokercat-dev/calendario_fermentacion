  ...
  return (
    <main className="px-5 pt-8">
      <header className="mb-8">
        ...
        <h1 className="mt-1 font-display text-4xl text-fg">Cultivo</h1>
          ...
          {nextCulture && next ? (
            <section className="space-y-3">
              <div className="flex items-end justify-between">
                <h2 className="font-display text-2xl">Próximo recambio</h2>
...
function EmptyState() {
  return (
    <section className="rounded-xl bg-surface px-5 py-8 text-center shadow-card">
