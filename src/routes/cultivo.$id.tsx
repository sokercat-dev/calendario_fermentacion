  ...
  return (
    <main className="px-5 pt-6 pb-8">
      ...
      {open?.photo ? (
        ...
        <div className="mb-5 flex aspect-[4/3] items-center justify-center rounded-xl bg-sunken">
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h1 className="font-display text-3xl">{culture.name}</h1>
        </div>
      ...
      <section className="mt-8">
        ...
        <ul className="mt-3 space-y-3">
          {history.map((batch) => {
            ...
            return (
              <li key={batch.id} className="flex gap-3 rounded-lg bg-surface p-3 shadow-card">
                {batch.photo ? (
      ...
      <section className="mt-8 rounded-xl border border-border px-4 py-4">
        ...
        <Link to="/guia" className="mt-2 inline-block text-sm font-medium text-primary">
          Ver la guía
        </Link>
      </section>
